...
- **During Final QC** - When QC Controllers fail a device

## How to view repair jobs
...
- Which technician is working on what
- How long jobs have been pending
- If technicians cancelled any jobs (they go back to Pending)
...
- Check if you have enough technicians working
- See if certain repair types are backing up
- Talk to technicians about any blockers
- Consider scheduling more staff for busy periods
